...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransaction = new EntityInsertionAdapter<Transaction>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`amount`,`type`,`categoryId`,`date`,`note`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public List<Transaction> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Transaction(_tmpId,_tmpAmount,_tmpType,_tmpCategoryId,_tmpDate,_tmpNote);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Transaction>> getTransactionsByCategory(final int catId) {
  ...
  @Override
  public Flow<Double> getTotalExpenses() {
    final String _sql = "SELECT SUM(amount) FROM transactions WHERE type = 'EXPENSE'";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Flow<Double> getTotalIncome() {
    final String _sql = "SELECT SUM(amount) FROM transactions WHERE type = 'INCOME'";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"transactions"}, new Callable<Double>() {
      @Override
      @Nullable
  ...
  @Override
  public Flow<List<Transaction>> getTransactionsByPeriod(final long startDate, final long endDate) {
