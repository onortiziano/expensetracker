...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`parentCategoryId`) VALUES (nullif(?, 0),?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getParentCategoryId() == null) {
          ...
          statement.bindLong(3, entity.getParentCategoryId());
        }
      }
    };
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final Integer _tmpParentCategoryId;
            ...
            _item = new Category(_tmpId,_tmpName,_tmpParentCategoryId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Category>> getSubCategories(final int parentId) {
    final String _sql = "SELECT * FROM categories WHERE parentCategoryId = ? ORDER BY name ASC";
  ...
  @Override
  public Flow<List<Category>> getMainCategories() {
    final String _sql = "SELECT * FROM categories WHERE parentCategoryId IS NULL ORDER BY name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"categories"}, new Callable<List<Category>>() {
      @Override
      @NonNull
